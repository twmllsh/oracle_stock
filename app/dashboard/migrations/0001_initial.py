# Generated by Django 5.1.1 on 2024-11-14 02:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.theme')),
                ('ticker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='themedtail_set', to='dashboard.ticker')),
            ],
            options={
                'verbose_name': '테마텍스트',
        ...
        migrations.AddField(
            model_name='theme',
            name='tickers',
            field=models.ManyToManyField(related_name='theme_set', through='dashboard.ThemeDetail', to='dashboard.ticker'),
        ),
        migrations.CreateModel(
            name='News',
            fields=[
                ...
                ('tickers', models.ManyToManyField(related_name='news_set', to='dashboard.ticker')),
            ],
        ),
        migrations.CreateModel(
            name='Iss',
            fields=[
                ...
                ('tickers', models.ManyToManyField(related_name='iss_set', to='dashboard.ticker')),
            ],
            options={
                'verbose_name': '이슈',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticker', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='dashboard.ticker')),
            ],
            options={
                'verbose_name': '기본정보',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20)),
                ('tickers', models.ManyToManyField(related_name='upjong_set', to='dashboard.ticker')),
            ],
            options={
                'verbose_name': '업종',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.ticker')),
            ],
            options={
                'verbose_name': 'OHLCV',
                'ordering': ['Date'],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['ticker', '-날짜', '투자자'], name='dashboard_i_ticker__8513c8_idx')],
